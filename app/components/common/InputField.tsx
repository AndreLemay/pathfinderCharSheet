...
export default function InputField(props: InputProps) {
    function change(event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) {
        ...
        let val: number | string = props.inputType === "number" ? 
        ...
        <div className={`form-group ${props.className || ""}`}>
            ...
            {props.inputType !== "textarea" ?
                <input className="form-control form-control-sm"
                    ...
                    step={props.inputType === "number" && props.step >= 0 ? props.step : undefined}
                    min={props.inputType === "number" && props.min >= 0 ? props.min : undefined}
                    max={props.inputType === "number" && props.max >= 0 ? props.max : undefined}
