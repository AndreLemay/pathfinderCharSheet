...
interface ModalProps {
    addFeat: (name: string, desc: string, bonuses: ValueBonus[]) => void
}
...
export default class FeatModal extends React.Component<ModalProps, ModalState> {
    ...
    render() {
        return (
            <div className="modal fade" id="addFeatModal" ref={this.modalRef} tabIndex={-1} role="dialog" aria-labelledby="addFeatModalTitle"
                aria-hidden="true">
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="addFeatModalTitle">New Feat</h5>
                        </div>
