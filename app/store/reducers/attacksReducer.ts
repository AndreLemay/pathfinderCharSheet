...
import { ToolbarActionTypes, AttackActionTypes, EquipmentActionTypes } from "../actions/actionTypes";

type AttackActions = typeof addAttack | typeof attackActions | typeof equipActions
