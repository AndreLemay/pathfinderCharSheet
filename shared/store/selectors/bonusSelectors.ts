...
import CharacterSheetState, { EquipmentState, FeatState, ValueBonus } from "../types";
import { BonusTypeValue, BonusType } from "../../api/enums";
import { EnumValue } from "ts-enums";

interface StatSumBundle {
    from: (EquipmentState | FeatState)[]
...
export const getBonusTotal = createSelector([getBundle], sumBonuses)