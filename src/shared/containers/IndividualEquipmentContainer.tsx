...
interface OwnProps {
	...
	equipmentComponent: React.FunctionComponent<EquipmentProps>
}
...
class IndividualEquipmentContainer extends React.Component<
	IndividualEquipmentContainerProps
> {
	edit = () => {
		this.props.openEquipModal(
			(equip: EquipInfoBundle) => {
