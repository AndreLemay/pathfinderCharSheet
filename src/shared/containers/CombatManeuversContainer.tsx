...
import {
	...
	getMiscCMB,
	getMiscCMD
} from '../store/selectors/combatManeuverSelectors'
import {
	getStrengthBonus,
	getDexterityBonus
...
interface OwnProps {
	className?: string
	combatManeuverComponent: React.FunctionComponent<CombatManeuvreProps>
}
...
class CombatManeuversContainer extends React.Component<
	CombatManeuversContainerProps
> {
	render() {
