...
import {
	...
	editFeat,
	deleteFeat
} from '../store/actions/featActions'
...
export interface OwnProps {
	...
	featComponent: React.FunctionComponent<FeatProps>
}
...
class IndividualFeatContainer extends React.Component<
	IndividualFeatContainerProps
> {
	edit = () => {
		this.props.openFeatModal(
			(feat: FeatInfoBundle) => {
