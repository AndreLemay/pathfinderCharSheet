	...
	return (
		<View>
			...
			<View style={[Styles.row]}>
				<OutputField label="CMB" containerStyle={[Styles.row]} value={props.cmb} />
				<OutputField
					label="STR"
					containerStyle={[Styles.row]}
					value={props.strBonus}
				/>
				<OutputField label="BAB" containerStyle={[Styles.row]} value={props.bab} />
			</View>
			<View style={[Styles.row]}>
				<OutputField
					label="Size"
			...
			<View style={[Styles.row]}>
				<OutputField label="CMD" containerStyle={[Styles.row]} value={props.cmd} />
				<OutputField label="Base" containerStyle={[Styles.row]} value={10} />
				<OutputField
					label="STR"
					containerStyle={[Styles.row]}
					value={props.strBonus}
