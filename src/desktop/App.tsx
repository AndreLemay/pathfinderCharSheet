...
export default class App extends React.Component {
	private readonly equipModalRef: React.RefObject<EquipmentModal>
	private readonly featModalRef: React.RefObject<FeatModal>
			...
			<Provider store={store}>
				<div>
					...
					<div className="container-fluid">
						<div className="row mt-4">
							<div className="col-6 px-5">
								...
								<InitiativeContainer
									...
									initiativeComponent={InitiativeSection}
								/>
							</div>
							<div className="col-6 px-5">
								<CharacterContainer
									className="form-row align-items-end"
									characterSectionComponent={CharacterSection}
								/>
								<HealthContainer
									className="form-row align-items-end"
									healthSectionComponent={HealthSection}
								/>
								<div className="row">
									<AttackBonusContainer
										className="col-4 pl-0"
										attackBonusComponent={AttackBonusSection}
									/>
						...
						<div className="row mt-4">
							<FeatsContainer
								className="col-4 pl-5"
								openFeatModal={this.openFeatModal}
								featsSectionComponent={FeatsSection}
							/>
							<SkillsContainer
								className="col-8 px-5"
								skillsSectionComponent={SkillsSection}
							/>
						</div>
						<div className="row mt-4">
							<div className="col-6 px-5">
								<div className="row">
									<ArmourClassContainer
										className="col"
										armourClassComponent={ArmourClassSection}
									/>
								</div>
								<div className="row">
									<CombatManeuversContainer
										className="col"
						...
						<div className="row mt-4">
							...
							<EquipmentContainer
								className="col-6 px-5"
								openEquipModal={this.openEquipModal}
								equipmentSectionComponent={EquipmentSection}
							/>
						</div>
					</div>
				</div>
