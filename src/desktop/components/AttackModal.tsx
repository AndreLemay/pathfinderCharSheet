	...
	render() {
		return (
			<div
				...
				tabIndex={-1}
				role="dialog"
				aria-labelledby="addAttackModalTitle"
				aria-hidden="true">
				<div className="modal-dialog modal-lg" role="document">
					<div className="modal-content">
						<div className="modal-header">
							<h5 className="modal-title" id="addAttackModalTitle">
								New Attack
							</h5>
						</div>
										...
										<div className="input-group input-group-sm">
											...
											<select
												...
												<option value={DamageDie[2].propName}>
													{DamageDie[2].description}
												</option>
												<option value={DamageDie[3].propName}>
													{DamageDie[3].description}
												</option>
												<option value={DamageDie[4].propName}>
													{DamageDie[4].description}
												</option>
												<option value={DamageDie[6].propName}>
													{DamageDie[6].description}
												</option>
												<option value={DamageDie[8].propName}>
													{DamageDie[8].description}
												</option>
												<option value={DamageDie[10].propName}>
													{DamageDie[10].description}
												</option>
												<option value={DamageDie[12].propName}>
													{DamageDie[12].description}
												</option>
												<option value={DamageDie[20].propName}>
													{DamageDie[20].description}
												</option>
											</select>
										</div>
									</div>
