...
export default class Toolbar extends React.Component<ToolbarProps, OwnState> {
	...
	onSaveClicked = () => {
		let savePath = path.join(
			...
			'pfCharSheets',
			`${this.props.defaultSaveName()}.sav`
		)
		remote.dialog.showSaveDialog(
			...
			filePath => {
				jetpack.write(
					filePath.endsWith('.sav') ? filePath : `${filePath}.sav`,
					this.props.getSaveFile()
				)
			}
		)
	}
				...
				<div className="navbar-nav">
					<div className="nav-item dropdown">
						...
						<div className="dropdown-menu" aria-labelledby="fileMenuLink">
							<a className="dropdown-item" href="#" onClick={this.onSaveClicked}>
								Save
							</a>
							<a className="dropdown-item" href="#" onClick={this.onLoadClicked}>
								Load
							</a>
						</div>
					</div>
					<div className="nav-item">
						<a href="#" className="nav-link" onClick={this.props.addEquip}>
							Add Equipment
						</a>
					</div>
					<div className="nav-item">
						<a href="#" className="nav-link" onClick={this.props.addAttack}>
							Add Attack
						</a>
					</div>
					<div className="nav-item">
						<a href="#" className="nav-link" onClick={this.props.addFeat}>
							Add Feat
						</a>
					</div>
				</div>
