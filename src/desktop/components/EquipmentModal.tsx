...
export default class EquipmentModal extends React.Component<any, ModalState> {
	...
	private def: Promise<EquipInfoBundle>
	private defResolve: (arg0: EquipInfoBundle) => void
	...
	render() {
		return (
			<div
				...
				tabIndex={-1}
				role="dialog"
				aria-labelledby="addEquipmentModalTitle"
				aria-hidden="true">
				<div className="modal-dialog modal-lg" role="document">
					<div className="modal-content">
						<div className="modal-header">
							<h5 className="modal-title" id="addEquipmentModalTitle">
								New Equipment
							</h5>
						</div>
