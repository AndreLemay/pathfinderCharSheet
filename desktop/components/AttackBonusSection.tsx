    ...
    return (
        <div className={props.className}>
            ...
            <div className="form-row">
                ...
                <OutputField label="Misc" fieldType="number" className="col" value={props.miscBonus} />
            </div>
            <div className="form-row">
                <OutputField label="Melee" fieldType="number" className="col" value={props.meleeBonus} />
                <OutputField label="Ranged" fieldType="number" className="col" value={props.rangedBonus} />
            </div>
        </div>
    )
}