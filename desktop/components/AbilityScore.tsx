...
export default function AbilityScore(props: AbilityScoreProps) {
    return (
        <div className="form-row align-items-end">
            ...
            <InputField label="Base" className="col" inputType="number"
                min={1}
                value={props.base} 
                onValueChange={props.baseChange} />
            <OutputField label="Additional" className="col" fieldType="number" value={props.additional} />
            <OutputField label="Bonus" className="col" fieldType="number" value={props.bonus} />
        </div>
    )
}